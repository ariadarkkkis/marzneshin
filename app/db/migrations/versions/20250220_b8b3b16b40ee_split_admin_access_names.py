...
def upgrade() -> None:
    ...
    op.add_column('admins', sa.Column('add_users_access', sa.Boolean(), server_default=sa.text('1'), nullable=False))
    op.add_column('admins', sa.Column('edit_users_access', sa.Boolean(), server_default=sa.text('0'), nullable=False))
    op.add_column('admins', sa.Column('delete_users_access', sa.Boolean(), server_default=sa.text('1'), nullable=False))
    op.add_column('admins', sa.Column('delete_expired_users_access', sa.Boolean(), server_default=sa.text('1'), nullable=False))
    op.add_column('admins', sa.Column('reset_users_usage_access', sa.Boolean(), server_default=sa.text('0'), nullable=False))
    op.add_column('admins', sa.Column('toggle_users_status_access', sa.Boolean(), server_default=sa.text('1'), nullable=False))
    op.add_column('admins', sa.Column('revoke_users_sub_access', sa.Boolean(), server_default=sa.text('1'), nullable=False))
...
def downgrade() -> None:
    ...
    #            nullable=False,
    #            existing_server_default=sa.text("'none'"))
    op.add_column('admins', sa.Column('modify_users_access', sa.BOOLEAN(), server_default=sa.text('1'), nullable=False))
